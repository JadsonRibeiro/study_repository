...
<body>
	...
	<div id="form_sacar">
		<form action="manipula_banco.php" method="post">
			<div class="input-field col s6">
				<input type="hidden" name="numero_conta" value="<?php echo $numero_conta ?>">
				<input type="text" name="value_sacar" class="value_sacar"> <br/>
	...
	<div id="field_ler_extrato">
		<button class="btn_ler_extrato waves-effect waves-light btn"> LER EXTRATO - TXT </button>
	</div>
	<br/>
	<button class="btn_menu waves-effect waves-light btn"> MENU </button>
</body>
</html>