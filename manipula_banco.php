...
if(isset($_POST['btn_inserir'])) {
	...
	$data_url= "?resp_nome=$dados->nome&resp_end_rua=$dados->end_rua&resp_end_bairro=$dados->end_bairro&resp_end_numero=$dados->end_numero";
}
	
header("location:formulario.php$data_url");
?>